...
function About() {
  return (
    <div className="About">
      <img className="about-image" src={aboutImage} alt="coder-image" />
      ...
      <a className="wt-wwm" href="https://discord.com/users/778132615307853855">Work With Me</a>
      <a className="wt-smp" href="https://github.com/Heatwave-Eli?tab=repositories">See My Past Work</a>
    </div>
  );
}
